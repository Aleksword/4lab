object Form1: TForm1
  ...
  object BoldGrid1: TBoldGrid
    ...
    Columns = <
      ...
      item
        BoldProperties.Expression = 'iD_Place'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        Font.Style = []
        Title.Caption = 'ID Place'
      end
      item
        BoldProperties.Expression = 'iD_Room'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        Font.Style = []
        Title.Caption = 'ID Room'
      end
      item
        BoldProperties.Expression = 'place_number'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        Font.Style = []
        Title.Caption = 'Place number'
      end>
    DefaultRowHeight = 17
  ...
  object BoldGrid2: TBoldGrid
    ...
    Columns = <
      ...
      item
        BoldProperties.Expression = 'passport'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        Font.Style = []
        Title.Caption = 'Passport'
      end
      item
        BoldProperties.Expression = 'fIO'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      item
        BoldProperties.Expression = 'iD_Client'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        Font.Style = []
        Title.Caption = 'ID Client'
      end>
    DefaultRowHeight = 17
    EnableColAdjust = False
    TabOrder = 2
  ...
  object BoldListHandle1: TBoldListHandle
    ...
    Expression = 'Place.allInstances'
    Left = 200
    Top = 128
  end
  object BoldListHandle2: TBoldListHandle
    RootHandle = BoldSystemHandle1
    Expression = 'Client.allInstances'
    Left = 528
    Top = 128
  end
